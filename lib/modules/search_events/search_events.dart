...
import 'package:productivity_app/model/event_data_source.dart';
import 'package:productivity_app/modules/search_events/search_controller.dart' as searchController;
...
class SearchEvents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<searchController.SearchController>(
